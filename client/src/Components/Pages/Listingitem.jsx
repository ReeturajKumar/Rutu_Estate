  ...
  return (
    <div className='bg-white shadow-md hover:shadow-lg transition-shadow overflow-hidden rounded-lg w-full sm:w-[300px]'>
      <Link to={`/listing/${listing._id}`}>
        <img src={listing.imageUrl[0]} alt=""  className='h-[320px] sm:h-[220px] w-full object-cover hover:scale-105 transition-scale duration-300 pb-4'/>
        ...
        <div className="p-3 flex flex-col gap-3 w-full">
          ...
          <p className='text-sm text-gray-600 line-clamp-3'>{listing.desc}</p>
          <p className='text-slate-500 mt-2 font-semibold flex text-center'>
          ₹{listing.offer ? listing.discountPrice.toLocaleString('en-US') : listing.regularPrice.toLocaleString('en-US')}

          {listing.type === 'rent' && ' / month'}
          </p>
          <div className="flex text-slate-700 gap-5">
